...
if btn_process and text_to_translate.strip():
    ...
    with st.spinner("..."):
        ...
        if is_single_word:
            ...
            # بناء جدول سياقي احترافي يعطي الكلمة بأكثر من معنى في أكثر من سياق
            if lang_to == "ar":
                st.markdown(f"""
        ...
        # 🔵 الحالة الثانية: إذا كانت المدخلات "جملة أو تقرير كامل" (تفعيل ميزة تعدد الصيغ)
            ...
            # جلب الترجمة الخام الأساسية أولاً
            ...
            # 📊 عرض الصيغ الثلاثة بجانب بعضها في واجهة فائقة الفخامة والأناقة
